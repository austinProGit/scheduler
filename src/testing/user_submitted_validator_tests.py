...
def user_submitted_validator_tests():
    ...
    add_test("single_prereq_problem_same_sem", single_prereq_problem_same_sem, ['CPSC 4176 taken before CPSC 4175.'])
    add_test("single_prereq_problem_dif_sem", single_prereq_problem_dif_sem, ['CPSC 4176 taken before CPSC 4175.'])
    add_test("multiple_prereq_problem_mixed_sem", multiple_prereq_problem_mixed_sem, ['CPSC 4115 taken before CPSC 2108.'])
    add_test("multiple_prereq_problem_dif_sem", multiple_prereq_problem_dif_sem, ['CPSC 4115 taken before CPSC 2108.', 'CPSC 4115 taken before MATH 5125.'])
