...
def degreeworks_parser_v2_tests():
    ...
    degreeworks_input_1_ex_out = DegreeExtractionContainer(
        ...
        4498 or 5133U or 5135U or 5136U  or 5137U  or 5545U>
            [d <n=KINS 3107>]
            [d <n=KINS 4147>]
            [d <n=KINS 4498>]
            [d <n=KINS 5133U>]
    ...
    for test in test_case_list:
        ...
        if test_container._student_name and test["ex_out"]._student_name:
            ...
            print(f'real_container student name: {test["ex_out"]._student_name}')
            print()
        ...
        if test_container._student_number and test["ex_out"]._student_number:
            ...
            print(f'real_container student number: {test["ex_out"]._student_number}')
            print()
        ...
        if test_container._degree_plan_name and test["ex_out"]._degree_plan_name:
            ...
            print(f'real_container degree plan name: {test["ex_out"]._degree_plan_name}')
            print()
        ...
        if test_container._courses_needed_constuction_string and test["ex_out"]._courses_needed_constuction_string:
            ...
            print(f'real_container courses needed construction string: {test["ex_out"]._courses_needed_constuction_string}')
            print()
        ...
        if test_container._taken_courses and test["ex_out"]._taken_courses:
            ...
            print(f'real_container taken courses: {test["ex_out"]._taken_courses}')
            print()
